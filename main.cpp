...
int main() {
    ...
    long long total_iterations = 100000000000;
    ...
    cout << "Starting Monte Carlo pi estimation" << endl;
    cout << string(70, '=') << endl;
    ...
    for (long long i = 1; i <= total_iterations; i++) {
        ...
        if (checkpoint_index < checkpoints.size() && i == checkpoints[checkpoint_index]) {
            ...
            cout << "  pi estimate: " << fixed << setprecision(10) << pi_estimate << endl;
            cout << "  Accuracy: " << accuracy << endl;
            cout << "  Execution time: " << setprecision(2) << execution_time.count() << " sec" << endl;
            cout << "  Time per point: " << scientific << time_per_point << " sec" << endl;
            cout << string(70, '-') << endl;
        ...
        if (i % 10000000 == 0) {
            cout << "Progress: " << i << " / " << total_iterations 
                 << " points (" << fixed << setprecision(2) 
    ...
    cout << "Total time: " << fixed << setprecision(2) << total_time.count() << " seconds" << endl;
    cout << "Results saved to: results/pi_monte_carlo_results.csv" << endl;
